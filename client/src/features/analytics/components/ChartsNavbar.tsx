...
const ChartsNavbar = (props: React.PropsWithoutRef<ChartsNavbarProps>) => {
    ...
    const filterDurations = filters.map(filter => {
    ...
    const currentSelectFilterName = filters.find(filter => filter.value === props.filterValue)?.name || "Last 7 days";
