...
type CampaignTypesAnalyticsProps = {
    title: string;
    isLoading: boolean;
    campaigns: CampaignAnalyticsResponse["campaignTypes"] | undefined;
};

const CampaignTypesAnalytics = (props: React.PropsWithoutRef<CampaignTypesAnalyticsProps>) => {
...
export default CampaignTypesAnalytics