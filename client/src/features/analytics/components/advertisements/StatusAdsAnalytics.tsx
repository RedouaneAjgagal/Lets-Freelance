...
type StatusAdsAnalyticsProps = {
    title: string;
    isLoading: boolean;
    ads: AdsAnalyticsResponse["statusAds"] | undefined;
};

const StatusAdsAnalytics = (props: React.PropsWithoutRef<StatusAdsAnalyticsProps>) => {
...
export default StatusAdsAnalytics