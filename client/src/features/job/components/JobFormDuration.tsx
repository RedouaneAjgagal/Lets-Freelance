...
const JobFormDuration = (props: React.PropsWithoutRef<JobFormDurationProps>) => {
    ...
    return (
        <div className="flex items-center gap-2">
            <Input errorMsg="" id={`job_duration_value`} name={`job_duration_value`} includeLabel labelContent="Job duration" isError={props.isError} type="number" defaultValue={props.defaultValue.dateValue} />
