...
const MessageItem = (props: React.PropsWithoutRef<MessageItemProps>) => {
    ...
    const openChatHandler = () => {
        console.log(`Open chat with user ${props.messageContent.profile.user}`);
    }

    return (
        <li>
            <button onClick={openChatHandler} className={`py-2 px-4 text-left w-full hover:bg-blue-100/30`}>
