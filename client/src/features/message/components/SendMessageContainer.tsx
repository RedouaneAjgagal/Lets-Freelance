...
const SendMessageContainer = () => {
    ...
    return (
        <div className="p-4 flex items-center gap-2 border-t">
            <textarea onKeyDown={onKeyDownMessage} ref={textareaRef} onChange={setMessageContentHandler} name="sendMessage" id="sendMessage" className="max-h-[6rem] w-full border border-slate-300 px-3 py-1 outline-none rounded-2xl resize-none bg-stone-100/60 placeholder:text-slate-600" rows={1} placeholder="Send message.." />
