    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-1">
                <textarea onChange={setCoverLetterLengthHandler} name="submitProposal_coverLetter" id="submitProposal_coverLetter" className={`${props.errorMsg !== "" ? "border-red-300" : "border-slate-300"} border-2 text-slate-600 rounded py-2 px-3 outline-none focus:border-slate-500 w-full resize-none min-h-[10rem]`} autoComplete="false" maxLength={MAX_LENGTH}></textarea>
