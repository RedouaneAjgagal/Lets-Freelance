        ...
        <tr className="border-t">
            ...
            <td className="p-2 py-4">
                <div className="flex flex-col">
                    ...
                    <Link target="_blank" rel="noopener" to={`/profiles/${props.eventReport.submittedBy.profile}`} className="capitalize flex items-center gap-1 self-start text-blue-700 text-lg">
