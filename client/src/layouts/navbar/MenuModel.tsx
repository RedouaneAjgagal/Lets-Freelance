...
const MenuModel = (props: React.PropsWithoutRef<Props>) => {
    return (
        <ul className={`bg-white min-h-screen fixed w-full duration-150 flex flex-col py-4 text-lg  text-slate-600 font-medium z-[100] ${props.isShown ? "left-0" : "-left-full"}`}>
